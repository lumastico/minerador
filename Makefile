...
am__cpuminer_SOURCES_DIST = cpu-miner.c util.c uint256.cpp api.c \
	...
	algo/timetravel10.c algo/tribus.c algo/veltor.c \
	algo/whirlpool/whirlpool.c algo/whirlpool/whirlpoolx.c \
	algo/x11/x11.c algo/x11/x11evo.c algo/x11/x11gost.c \
	algo/x11/c11.c algo/x13/x13.c algo/x14/x14.c algo/x15/x15.c \
	algo/x17/x17.c algo/xevan.c algo/yescrypt/yescrypt.c \
	algo/yescrypt/yescrypt-common.c algo/yescrypt/sha256_Y.c \
	algo/yescrypt/yescrypt-simd.c algo/zr5.c asm/neoscrypt_asm.S \
...
ACLOCAL = ${SHELL} /home/ubuntu/cpuminer-opt/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/ubuntu/cpuminer-opt/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/cpuminer-opt/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/cpuminer-opt/missing automake-1.14
AWK = gawk
CC = gcc -std=gnu99
CCAS = gcc -std=gnu99
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/ubuntu/cpuminer-opt/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
VERSION = 3.6.6
WS2_LIBS = 
abs_builddir = /home/ubuntu/cpuminer-opt
abs_srcdir = /home/ubuntu/cpuminer-opt
abs_top_builddir = /home/ubuntu/cpuminer-opt
abs_top_srcdir = /home/ubuntu/cpuminer-opt
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/ubuntu/cpuminer-opt/install-sh
...
cpuminer_SOURCES = cpu-miner.c util.c uint256.cpp api.c sysinfos.c \
	...
	algo/x17/x17.c algo/xevan.c algo/yescrypt/yescrypt.c \
	algo/yescrypt/yescrypt-common.c algo/yescrypt/sha256_Y.c \
	algo/yescrypt/yescrypt-simd.c algo/zr5.c $(am__append_1) \
